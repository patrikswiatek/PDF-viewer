...
class Fonts extends React.Component {
  ...
  onClickFantasy = () => {
    document.getElementById("view").setAttribute("fontFamily", "Fantasy");
    document.getElementById("view").style.fontSize = "1rem";
    document.getElementById("createText").setAttribute("fontFamily", "Fantasy");
    document.getElementById("createText").style.fontSize = "1rem";
  };
  ...
  render() {
    return (<div className='fonts'>
        ...
        <div className='buttonsFonts'>
          <button className='btn btn-block btn-primary btn-add buttonFont'
                  onClick={this.onClickVerdana}>Verdana
          </button>
          <button className='btn btn-block btn-primary btn-add buttonFont'
                  onClick={this.onClickFantasy}>Fantasy
          </button>
          <button className='btn btn-block btn-primary btn-add buttonFont'
                  onClick={this.onClickTimes}>Times New Roman
          </button>
          <button className='btn btn-block btn-primary btn-add buttonFont'
                  onClick={this.onClickOpenSans}>Open Sans
          </button>
          <button className='btn btn-block btn-primary btn-add buttonFont'
                  onClick={this.onClickDefault}>Default
          </button>
        </div>
      </div>);
  }
